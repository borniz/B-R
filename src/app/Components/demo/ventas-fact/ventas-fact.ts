...
import { ActivatedRoute, provideRouter, Router, RouterModule, withComponentInputBinding } from '@angular/router';
...
export class VentasFact {
  public servicio = inject(Servicios);
  servicioActual:any;
  constructor(private ruter:Router){

    this.servicioActual= this.ruter.getCurrentNavigation
  }
  ...
  toggleModulo(id:string) {
    alert(`se envio el a togglemodule ${id}`)
  }
  regresarAlCatalogo(){
